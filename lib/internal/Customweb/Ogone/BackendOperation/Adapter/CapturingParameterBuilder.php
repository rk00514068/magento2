...
//require_once 'Customweb/Ogone/MaintenanceParameterBuilder.php';


class Customweb_Ogone_BackendOperation_Adapter_CapturingParameterBuilder extends Customweb_Ogone_MaintenanceParameterBuilder {
	...
	protected function getOperationParameter() {
		if (Customweb_Payment_Util::amountEqual($this->getTransaction()->getAuthorizationAmount(), $this->captureAmount) || $this->close) {
			return array('OPERATION' => Customweb_Ogone_IAdapter::OPERATION_CAPTURE_FULL);
		}
		else {
			return array('OPERATION' => Customweb_Ogone_IAdapter::OPERATION_CAPTURE_PARTIAL);
		}
	}
