 ...
 * @Bean
 */
class Customweb_Ogone_Method_Factory extends Customweb_Payment_Authorization_Method_AbstractFactory{
	
	protected function getMethodPackages() {
		return array('Customweb_Ogone_Method');
	}
	
	/**
	 * @return Customweb_Ogone_Method_DefaultMethod
	 */
