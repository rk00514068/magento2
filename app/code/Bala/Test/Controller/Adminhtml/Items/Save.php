...
class Save extends \Bala\Test\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('bala_test/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('bala_test/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('bala_test/*/new');
                }
                return;
            } catch (\Exception $e) {
