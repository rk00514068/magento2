...
namespace Customweb\OgoneCw\Model\ExternalCheckout;

/**
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\OgoneCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_ogonecw_external_checkout_context';
	...
	public function __construct(
			...
			\Customweb\OgoneCw\Helper\InvoiceItem $invoiceItemHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\OgoneCw\Model\ResourceModel\ExternalCheckout\Context');
    }
     ...
     *
     * @param int $quoteId
     * @return \Customweb\OgoneCw\Model\ExternalCheckout\Context
     */
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\OgoneCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\OgoneCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\OgoneCw\Model\ExternalCheckout\Context
     */
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\OgoneCw\Model\Payment\Method\AbstractMethod) {
			$data = [
