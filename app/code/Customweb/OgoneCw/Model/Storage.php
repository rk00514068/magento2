 ...
 * @method \Customweb\OgoneCw\Model\Storage setKeySpace(string $value)
 * @method string getKeyName()
 * @method \Customweb\OgoneCw\Model\Storage setKeyName(string $value)
 * @method string getKeyValue()
 * @method \Customweb\OgoneCw\Model\Storage setKeyValue(string $value)
 */
class Storage extends \Magento\Framework\Model\AbstractModel
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_ogonecw_storage';
    ...
    {
        $this->_init('Customweb\OgoneCw\Model\ResourceModel\Storage');
    }
