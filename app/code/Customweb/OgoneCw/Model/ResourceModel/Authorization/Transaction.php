...
namespace Customweb\OgoneCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\OgoneCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_ogonecw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\OgoneCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_ogonecw_transaction', 'entity_id');
    }
