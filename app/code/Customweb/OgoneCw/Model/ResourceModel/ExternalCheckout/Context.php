...
namespace Customweb\OgoneCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\OgoneCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_ogonecw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_ogonecw_external_checkout_context', 'context_id');
    }
