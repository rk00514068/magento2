...
class ConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
        ...
        public function getForm(AbstractMethod $method)
    {
		...
		return \Customweb_Licensing_OgoneCw_License::run('u2jes35dhkibkti5', $this, $arguments);
	}

	final public function call_ld57v4u029fk5sbg() {
    ...
    protected function getFailureMessage(AbstractMethod $method)
    {
    	if ($this->_checkoutSession->getQuote()->getPayment()->getMethod() == $method->getCode()) {
	    	$failureMessage = $this->_checkoutSession->getOgoneCwFailureMessage();
	    	if (!empty($failureMessage)) {
	    		$this->_checkoutSession->unsOgoneCwFailureMessage();
    ...
    protected function getImageUrl(AbstractMethod $method)
    {
    	try {
    		...
    		return $this->_assetRepo->getUrlWithParams('Customweb_OgoneCw/images/payment/method/' . $method->getPaymentMethodName() . '.png', $params);
    ...
    {
    	return new \Customweb\OgoneCw\Model\Renderer\CheckoutForm($method->getCode());
    }
