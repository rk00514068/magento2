...
class Endpoint extends \Customweb_Payment_Endpoint_AbstractAdapter
{
	...
	public function __construct(
			...
			\Customweb\OgoneCw\Model\Configuration $configuration
	) {
	...
	protected function getBaseUrl() {
		return $this->_frontendUrlBuilder->setScope($this->_configuration->getStore())->getUrl('ogonecw/endpoint/index', ['_secure' => true, '_nosid' => true]);
	}
	...
	public function getFormRenderer() {
		return new \Customweb\OgoneCw\Model\Renderer\FrontendForm();
	}
}