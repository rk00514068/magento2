...
namespace Customweb\OgoneCw\Model\Adapter;
...
class LayoutRenderer extends \Customweb_Mvc_Layout_Renderer
{
	...
	{
		$this->_view->loadLayout(['default', 'ogonecw_layout_renderer'], true, true, false);
		...
		$this->_view->getPage()->getConfig()->addPageAsset('Customweb_OgoneCw::css/ogonecw.css');
	}
	...
	{
		$this->_view->getLayout()->addBlock('\Magento\Framework\View\Element\Text', 'ogonecw.main.content', 'content')->setText($content);
	}
