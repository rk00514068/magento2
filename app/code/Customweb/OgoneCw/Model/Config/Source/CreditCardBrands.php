...
class CreditCardBrands implements \Magento\Framework\Option\ArrayInterface
{
	...
	public function toOptionArray()
	{
		return [
			...
			['value' => 'DiscoverCard', 'label' => __('Discover Card')],
			['value' => 'jcb', 'label' => __('JCB')],
			['value' => 'maestrouk', 'label' => __('Maestro UK')],
			['value' => 'maestro', 'label' => __('Maestro')],
			['value' => 'cartebleu', 'label' => __('Carte Bleue')],
			['value' => 'solo', 'label' => __('Solo Card')],
			['value' => 'UATP', 'label' => __('UATP')],
		];
	}
}
