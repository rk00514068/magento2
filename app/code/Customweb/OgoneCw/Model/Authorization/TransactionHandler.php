...
class TransactionHandler implements \Customweb_Payment_ITransactionHandler
{
	...
	public function persistTransactionObject(\Customweb_Payment_Authorization_ITransaction $transaction)
	{
		...
		} catch (\Customweb\OgoneCw\Model\Exception\OptimisticLockingException $e) {
	 ...
	 * @param mixed $value
	 * @param string $field
	 * @return null|\Customweb\OgoneCw\Model\Authorization\Transaction
	 */
	 ...
	 */
	private function storeInCache(\Customweb\OgoneCw\Model\Authorization\Transaction $transaction)
	{
