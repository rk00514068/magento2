...
namespace Customweb\OgoneCw\Model\Authorization\Method;
...
abstract class AbstractMethod
{
	...
	/**
	 * @var \Customweb\OgoneCw\Model\Authorization\TransactionContextFactory
	 */
	...
	/**
	 * @var \Customweb\OgoneCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory
	 */
	protected $_transactionCollectionFactory;

	/**
	 * @var \Customweb\OgoneCw\Model\Authorization\Method\Context\Factory
	 */
	...
	/**
	 * @var \Customweb\OgoneCw\Model\Authorization\Method\Context\IContext
	 */
	private $context;
	 ...
	 * @param \Customweb\OgoneCw\Model\Authorization\TransactionContextFactory $transactionContextFactory
	 * @param \Customweb\OgoneCw\Model\Authorization\TransactionFactory $transactionFactory
	 * @param \Customweb\OgoneCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory
	 * @param \Customweb\OgoneCw\Model\Authorization\Method\Context\Factory $contextFactory
	 * @param \Customweb\OgoneCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function __construct(
			...
			\Customweb\OgoneCw\Model\Authorization\TransactionContextFactory $transactionContextFactory,
			\Customweb\OgoneCw\Model\Authorization\TransactionFactory $transactionFactory,
			\Customweb\OgoneCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory,
			\Customweb\OgoneCw\Model\Authorization\Method\Context\Factory $contextFactory,
			\Customweb\OgoneCw\Model\Authorization\Method\Context\IContext $context
	...
	/**
	 * @return \Customweb\OgoneCw\Model\Authorization\Method\Context\IContext
	 */
	public function getContext()
	{
		if (!($this->context instanceof \Customweb\OgoneCw\Model\Authorization\Method\Context\IContext)) {
	 ...
	 * @param \Customweb\OgoneCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function setContext(\Customweb\OgoneCw\Model\Authorization\Method\Context\IContext $context)
	{
		$this->context = $context;
	}
	...
	public function initializeTransaction(\Customweb\OgoneCw\Model\Authorization\Transaction $transaction)
	{
		...
		$this->_checkoutSession->unsOgoneCwCheckoutId();
	...
	public function finishAuthorization()
	{
		if ($this->getContext()->getTransaction()->getTransactionObject()->isAuthorized()) {
			if ($this->getContext()->getPaymentMethod() instanceof \Customweb\OgoneCw\Model\Payment\Method\AbstractMethod) {
				$this->_coreRegistry->register('ogonecw_authorization_transaction', $this->getContext()->getTransaction());
				...
				if ($this->getContext()->getTransaction()->getTransactionObject()->isCaptured()) {
					...
					$invoice = $this->_coreRegistry->registry('ogonecw_invoice');
				} else {
	...
	/**
	 * @return \Customweb\OgoneCw\Model\Authorization\Transaction|null
	 */
