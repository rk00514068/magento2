...
class Factory
{
     ...
     */
    public function create(\Customweb\OgoneCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\OgoneCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\OgoneCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\OgoneCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\OgoneCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\OgoneCw\Model\Authorization\Method\Context\Factory
     */
