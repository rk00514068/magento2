...
class OrderContext implements \Customweb_Payment_Authorization_IOrderContext
{
	 ...
	 * @param \Customweb\OgoneCw\Model\Payment\Method\AbstractMethod|string $paymentMethod
	 * @throws \Exception
	 */
	...
	private function assembleDataFromQuote(
		...
		$checkoutId = $checkoutSession->getOgoneCwCheckoutId();
		if(empty($checkoutId)){
			$checkoutId = \Customweb_Core_Util_Rand::getUuid();
			$checkoutSession->setOgoneCwCheckoutId($checkoutId);
		}
