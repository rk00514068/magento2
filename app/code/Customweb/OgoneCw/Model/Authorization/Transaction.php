...
use \Customweb\OgoneCw\Api\Data\TransactionInterface;

/**
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setEntityId(int $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setTransactionExternalId(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setOrderId(int $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setOrderIncrementId(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setOrderPaymentId(int $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setAliasForDisplay(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setAliasActive(boolean $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setPaymentMethod(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setTransactionObject(\Customweb_Payment_Authorization_ITransaction $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setAuthorizationType(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setCustomerId(int $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setUpdatedOn(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setCreatedOn(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setPaymentId(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setExecuteUpdateOn(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setAuthorizationAmount(float $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setAuthorizationStatus(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setPaid(boolean $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setLiveTransaction(boolean $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setCurrency(string $value)
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\OgoneCw\Model\Authorization\Transaction setVersionNumber(int $value)
 */
class Transaction extends \Magento\Framework\Model\AbstractModel implements \Magento\Sales\Model\EntityInterface, TransactionInterface
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_ogonecw_transaction';
	 ...
	 * @var string
	 */
	protected $_entityType = 'ogonecw_transaction';
	...
	{
		$this->_init('Customweb\OgoneCw\Model\ResourceModel\Authorization\Transaction');
	}
	...
	public function afterSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof \Customweb_Payment_Authorization_ITransaction) {
			...
			if ($customerContext instanceof \Customweb\OgoneCw\Model\Authorization\CustomerContext) {
				try {
		...
		if ($this->_registry->registry('initializeTransaction') !== false && $this->getTransactionObject() == null) {
			...
			/* @var $adapter \Customweb\OgoneCw\Model\Authorization\Method\AbstractMethod */
