...
class GuestPost extends \Customweb\OgoneCw\Controller\ExternalCheckout
{
	/**
	...
	public function execute()
	{
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\OgoneCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
			$data = [
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\OgoneCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST))) {
