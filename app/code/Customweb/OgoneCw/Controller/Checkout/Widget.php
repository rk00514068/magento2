...
class Widget extends \Customweb\OgoneCw\Controller\Checkout
{
	public function execute()
	{
		$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
		/* @var $authorizationMethodAdapter \Customweb\OgoneCw\Model\Authorization\Method\Widget */
		...
		$resultPage->getLayout()
			->getBlock('customweb_ogonecwcheckout_widget')
