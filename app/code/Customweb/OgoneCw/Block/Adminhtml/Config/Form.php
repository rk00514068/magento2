...
namespace Customweb\OgoneCw\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_OgoneCw::ogonecw/config/form.phtml';

	/**
	 * @var \Customweb\OgoneCw\Model\Config\Structure
	 */
	protected $_formStructure;

	/**
	 * @var \Customweb\OgoneCw\Model\Renderer\Adminhtml\BackendForm
	 */
	protected $_backendFormRenderer;

	/**
	 * @param \Magento\Backend\Block\Template\Context $context
	 * @param \Customweb\OgoneCw\Model\Config\Structure $formStructure,
	 * @param \Customweb\OgoneCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\OgoneCw\Model\Config\Structure $formStructure,
			\Customweb\OgoneCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer,
			array $data = []
	) {
