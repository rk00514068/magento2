...
namespace Customweb\OgoneCw\Block\Adminhtml\Sales\Order\Invoice\Create;
...
class Components extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_OgoneCw::sales/order/invoice/create/components.phtml';
	...
	public function canCaptureNoClose()
	{
		...
		if (!($invoice->getOrder()->getPayment()->getMethodInstance() instanceof \Customweb\OgoneCw\Model\Payment\Method\AbstractMethod)) {
			return false;
		}
