...
namespace Customweb\OgoneCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('ogonecw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('ogonecw_transaction');
	}
	...
	{
		return $this->getUrl('ogonecw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('ogonecw/transaction/');
	}
}