...
namespace Customweb\OgoneCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\OgoneCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\OgoneCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\OgoneCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('ogonecw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('ogonecw/customer/aliases', ['_current' => true]);
    }
