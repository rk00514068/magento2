...
namespace Customweb\OgoneCw\Block\Checkout;
...
class AbstractCheckout extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @return \Customweb\OgoneCw\Block\Checkout\AbstractCheckout
	 */
	public function setTransaction(\Customweb\OgoneCw\Model\Authorization\Transaction $transaction)
	{
	...
	/**
	 * @param \Customweb\OgoneCw\Model\Authorization\Method\AbstractMethod $adapter
	 * @return \Customweb\OgoneCw\Block\Checkout\AbstractCheckout
	 */
	public function setAuthorizationAdapter(\Customweb\OgoneCw\Model\Authorization\Method\AbstractMethod $adapter)
	{
	...
	{
		if (!($this->authorizationAdapter instanceof \Customweb\OgoneCw\Model\Authorization\Method\AbstractMethod)) {
