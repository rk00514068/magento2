...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_OgoneCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('ogonecw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('ogonecw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('ogonecw/externalCheckout/registerPost', ['_secure' => true]);
	}
