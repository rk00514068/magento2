...
namespace Customweb\OgoneCw\Observer\ExternalCheckout;
...
{
	/**
	 * @var \Customweb\OgoneCw\Model\ExternalCheckout\Widget\Collection
	 */
	protected $_widgetCollection;

	/**
	 * @param \Customweb\OgoneCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	 */
	public function __construct(
			\Customweb\OgoneCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	) {
